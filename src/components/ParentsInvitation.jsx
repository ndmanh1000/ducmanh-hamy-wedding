    ...
    <div className="bg-paper py-10 px-6 text-center">
      ...
      <div className="flex justify-between gap-4 mb-8">
        ...
        <div className="flex-1 text-left">
          <div className="text-[#6d0208] font-lora text-xs uppercase tracking-widest border-b border-[#6d0208]/30 pb-1 mb-3">
            Nhà trai
          </div>
      ...
      {/* Divider */}
      <div className="w-px h-8 bg-[#6d0208]/30 mx-auto mb-4" />

      {/* Couple names */}
      <div className="flex items-center justify-center gap-3">
        <div className="font-dancing text-[#6d0208] text-[32px] leading-tight">
          Đức Mạnh
        </div>
