  ...
  return (
    <div className="bg-paper py-10 px-5">
      ...
      <div className="text-center mb-7">
        <div className="font-dancing text-[#5C3D2E] text-[42px] leading-none">
          Sổ lưu bút
        </div>
      ...
      <form onSubmit={handleSubmit} className="mb-8 space-y-3">
        <input
          ...
          className="w-full border border-[#5C3D2E]/20 rounded px-4 py-2.5 font-lora text-[14px] text-neutral-700 bg-white/70 focus:outline-none focus:border-[#5C3D2E]/50 placeholder:text-neutral-400"
        />
        <textarea
          ...
          rows={3}
          className="w-full border border-[#5C3D2E]/20 rounded px-4 py-2.5 font-lora text-[14px] text-neutral-700 bg-white/70 focus:outline-none focus:border-[#5C3D2E]/50 placeholder:text-neutral-400 resize-none"
        />
        <button
          type="submit"
          className="w-full bg-[#5C3D2E] text-white font-lora uppercase tracking-widest text-[13px] py-2.5 rounded hover:bg-[#7d5740] transition-colors"
        >
      ...
      <div className="space-y-3">
        {displayed.map((w, i) => (
          <div
            key={i}
            className="bg-white/70 border border-[#5C3D2E]/10 rounded-lg p-4"
          >
            <div className="font-lora font-semibold text-[#5C3D2E] text-[14px] mb-1">
              {w.name}
            </div>
      ...
      {wishes.length > 3 && !showAll && (
        <div className="mt-4 text-center">
          <button
            ...
            className="border border-[#5C3D2E] text-[#5C3D2E] font-lora uppercase tracking-widest text-[12px] px-6 py-2 rounded-full hover:bg-[#5C3D2E] hover:text-white transition-colors"
          >
            Xem thêm lời chúc
          </button>
        </div>
